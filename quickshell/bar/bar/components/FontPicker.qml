...
Column {
    ...
    Rectangle {
        ...
        Text {
            anchors { left: parent.left; leftMargin: 14 * root.uiScale; verticalCenter: parent.verticalCenter }
            text: "Search fonts\u2026"
        ...
        TextInput {
            id: field
            anchors { fill: parent; leftMargin: 14 * root.uiScale; rightMargin: 60 * root.uiScale }
