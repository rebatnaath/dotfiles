...
PanelWindow {
    ...
    // follow osdPosition (same as OSD volume/brightness)
    ...
    ListView {
        ...
        delegate: Item {
            ...
            // shadow matching card corner radius
            RectangularShadow {
                anchors.fill: card
                radius: root.notificationCornerRadius
                color: "#000000"
                blur: 0
                spread: 0
                offset: Qt.vector2d(8 * root.uiScale, 8 * root.uiScale)
                visible: root.notificationShadow
            }
            ...
            Rectangle {
                ...
                AccentBorder {
                    cornerRadius: root.notificationCornerRadius
                    visible: root.notificationBorder
                }
                ...
                Timer {
                    interval: 5000
                    running: true
                    // guard: entry may have been removed
                    onTriggered: {
